...
public class PageMrktEtoECompletedonly extends TestBase  {
...
@Test  
     ...
     actions.click().build().perform();
	  ...
	  driver.findElement(By.xpath("//input[@type='text'][@name='$PpyWorkPage$ppyLabel']")).sendKeys("NBABatcompltehlogic111111");
	  Thread.sleep(8000);
...
//		 js5.executeScript("arguments[0].scrollIntoView();", element6);	
  ...
  ///* old code 
	...
	///--------------------------------------------------------------------------------------------------------------//	 
		 ...
		 Assert.assertEquals(getTextOnPage1, "FAILED"); 
