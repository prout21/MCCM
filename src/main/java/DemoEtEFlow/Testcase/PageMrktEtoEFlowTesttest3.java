...
public class PageMrktEtoEFlowTesttest3 extends TestBase  {
...
@Test  
     ...
     actions.click().build().perform();
	  ...
	  driver.findElement(By.xpath("//input[@type='text'][@name='$PpyWorkPage$ppyLabel']")).sendKeys("NBABatchCampaig23456");
	  Thread.sleep(8000);
