...
@Test  
     ...
     actions.click().build().perform();
	  ...
	  driver.findElement(By.xpath("//input[@type='text'][@name='$PpyWorkPage$ppyLabel']")).sendKeys("NBABathCampaig10p23p");
	  Thread.sleep(8000);
  ...
  ///* old code 
	...
	///--------------------------------------------------------------------------------------------------------------//	 
		...
		//	WebElement w = CampaignRunID ;
			...
			WebElement 	w=driver.findElement(By.xpath("//span[.='Campaign run ID']/..//span[contains(.,'PR-')]"));
