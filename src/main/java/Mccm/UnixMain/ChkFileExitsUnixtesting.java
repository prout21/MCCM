...
public class ChkFileExitsUnixtesting     {
    ...
    public void Filechkunix() throws Exception
    {
	 //public static void main(String[] args) throws JSchException, InterruptedException {
       ...
       try {
		...
		//session = jsch.getSession("mccm02","ip-10-0-4-99.eu-central-1.compute.internal",18881);
       ...
       try {
		...
		System.out.println("Connect successful");
	      ...
	      ((ChannelExec) channel1) .setCommand("ssh mccm02@10.0.4.99 && unix11 ");
		//((ChannelExec) channel1) .setCommand("ssh -o StrictHostKeyChecking=No mccm02@10.0.4.99");
		((ChannelExec) channel1) .setCommand("cd /opt/SP/mccm/SYSN/mccm_dataload/import/input");
		((ChannelExec) channel1) .setCommand("ls");
      ...
      //Vector<LsEntry>  files = sftp.ls("/mccm02/dex_dev"); /import/input
